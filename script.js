...
//     let ambassador= utenti.filter(utenti =>utenti.isAmbassador===true);
//     console.log(ambassador+" è un ambassador")
//   }

const utenti=[];
utenti.push(marco,amy,paul);
for(i=0;i<=utenti.length;i++)
if (utenti.filter(utenti=>utenti.isAmbassador===true)){
...
const result= utenti.filter(utenti=>utenti.isAmbassador===true);
